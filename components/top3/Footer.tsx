const navGroups = [
  {
    heading: "コンテンツ",
    items: [
      { label: "代表より", href: "#about" },
      { label: "庭の一年", href: "#seasons" },
    ...
    <footer style={{ backgroundColor: "#EDF7E4" }}>
      <div className="max-w-6xl mx-auto px-6 py-16 flex flex-col md:flex-row gap-12 md:gap-20">
        ...
        <div className="flex-1">
          ...
          <p
            className="text-xs"
            style={{ fontFamily: "var(--top3-zen)", color: "#5C4033", opacity: 0.4 }}
          >
      ...
      >
        ...
        <p
          className="text-xs"
          style={{ fontFamily: "var(--top3-yomogi)", color: "#8DC86A", opacity: 0.6 }}
        >
          ※サンプルです
        </p>
      </div>
