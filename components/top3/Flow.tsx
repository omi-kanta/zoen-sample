...
// SVG vine path (縦方向、ステップ間をS字でつなぐ)
...
const VINE_LENGTH = 680; // approximate path length
                ...
                <div className="flex-1">
                  <div className="flex items-baseline gap-3 mb-2">
                    <span
                      ...
                      style={{ fontFamily: "var(--top3-klee)", color: "#8DC86A", opacity: 0.35 }}
                    >
                      {s.num}
                    </span>
                    <h3
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--top3-zen)", color: "#5C4033", opacity: 0.68 }}
                  >
                    {s.body}
                  </p>
                </div>
